...
- Python 3.10+
- [synesis](https://github.com/synesis-lang/synesis) >= 0.3.0
...
# Os quatro modos de operação {#sec-modos}
...
: Modos de operação do synesis-coder {.striped .hover}
...
: Variáveis de ambiente do synesis-coder {.striped .hover}
